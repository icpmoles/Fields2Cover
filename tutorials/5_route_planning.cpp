...
int main() {
  ...
  F2CSwathsByCells swaths_c = bf.generateSwaths(M_PI, robot_c.getCovWidth(), no_hl_c);

  f2c::rp::RoutePlannerBase route_planner;
  F2CRoute route = route_planner.genRoute(mid_hl_c, swaths_c, true);
